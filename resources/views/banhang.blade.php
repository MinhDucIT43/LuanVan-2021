    ...
    <div id="wrapper">
        <div class="ban">
            <div id="header">
                ...
                <b style="color: white;" id="time">{{date('d/m/Y h:i:s a')}}, {{Session::get('vaitrothungan')}}</b>
            </div>
            <div id="cacban">
                    @foreach($ban as $b)
                        @if($tableisworking)
        ...
        <div id="danhsachmonan">
            ...
            <a href="{{ route('dangxuatthungan') }}" class="btn btn-danger" id="logout"><i class="fas fa-sign-out-alt">Đăng xuất</i></a>
